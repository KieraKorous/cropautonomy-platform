...
// What shows under the image, and the pill, depend on where the capture is in
// the pipeline. Plant type only exists once analysis has succeeded; until then
// we surface the in-flight state.
